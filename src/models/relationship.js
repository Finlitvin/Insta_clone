...
// belongsToMany - many-to-many
    ...
    Users.belongsToMany(Roles, {through: UsersRoles, foreignKey: 'user_id', onDelete: 'CASCADE'});
    Roles.belongsToMany(Users, {through: UsersRoles, foreignKey: 'role_id', onDelete: 'CASCADE'});

    // posts - posts_tags - tags
    Posts.belongsToMany(Tags, {through: PostsTags, foreignKey: 'post_id', onDelete: 'CASCADE'});
    Tags.belongsToMany(Posts, {through: PostsTags, foreignKey: 'tag_id', onDelete: 'CASCADE'});
